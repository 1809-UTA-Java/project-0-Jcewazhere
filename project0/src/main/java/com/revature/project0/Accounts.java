 ...
 * This class is value object representing database table accounts
...
public class Accounts implements Cloneable, Serializable {
	...
	public void setAcctID(int acctIDIn) {
		this.acctID = acctIDIn;
	}
	...
	public void setAcctType(String acctTypeIn) {
		this.acctType = acctTypeIn;
	}
	...
	public void setFinBal(String finBalIn) {
		this.finBal = finBalIn;
	}
	...
	public void setAll(int acctIDIn, String acctTypeIn, int userIDIn, String finBalIn) {
		this.acctID = acctIDIn;
		this.acctType = acctTypeIn;
		this.userID = userIDIn;
		this.finBal = finBalIn;
	...
	/**
	 * hasEqualMapping-method will compare two Accounts instances and return true if
	 ...
	 */
	public boolean hasEqualMapping(Accounts valueObject) {

		if (valueObject.getAcctID() != this.acctID) {
			return (false);
		}
		if (this.acctType == null) {
			if (valueObject.getAcctType() != null)
				return (false);
		} else if (!this.acctType.equals(valueObject.getAcctType())) {
			return (false);
		}
		...
		if (this.finBal == null) {
			if (valueObject.getFinBal() != null)
				return (false);
		} else if (!this.finBal.equals(valueObject.getFinBal())) {
			return (false);
		}
	...
	public String toString() {
		...
		out.append("\nclass Accounts, mapping to table accounts\n");
		out.append("Persistent attributes: \n");
		out.append("acctID = " + this.acctID + "\n");
		out.append("acctType = " + this.acctType + "\n");
		out.append("userID = " + this.userID + "\n");
		out.append("finBal = " + this.finBal + "\n");
		return out.toString();
	}
	 ...
	 */
	public Object clone() {
		Accounts cloned = new Accounts();

		cloned.setAcctID(this.acctID);
		if (this.acctType != null)
			cloned.setAcctType(new String(this.acctType));
		cloned.setUserID(this.userID);
		if (this.finBal != null)
			cloned.setFinBal(new String(this.finBal));
		return cloned;
	}
